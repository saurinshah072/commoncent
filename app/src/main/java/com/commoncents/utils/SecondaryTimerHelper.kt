...
class SecondaryTimerHelper(context: Context)
{
    ...
    companion object
    {
        const val PREFERENCES = "s_prefs"
        const val START_TIME_KEY = "s_startKey"
        const val STOP_TIME_KEY = "s_stopKey"
        const val COUNTING_KEY = "s_countingKey"
    }
}
